...
const T = {
  it: {
    ...
    team_title: "Cinque competenze, <em>un'unica missione.</em>",
    ...
    ame_role: "Referente Medica del Progetto in Sud America",
    ame_creds: [ic('stethoscope') + " Medico Pediatra", ic('pill') + " Specialista in Allergologia, Immunologia e Medicina Ambientale", ic('book') + " Vicedirettrice della Specializzazione in Allergologia e Immunologia (UBA)", ic('globe') + " Università di Buenos Aires (Argentina)"],
    ame_p1: "La Dott.ssa Amelia Zarauza è la referente medica del progetto per il Sud America. Medico pediatra specializzata in allergologia, immunologia e medicina ambientale, mette la sua competenza clinica al servizio dei contenuti su allergie e sicurezza alimentare.",
    ame_p2: "Vicedirettrice della Carriera di Specializzazione in Allergologia e Immunologia all'Università di Buenos Aires (UBA), ha curato la revisione clinica del gioco «Il Coraggio di Agire» e dei moduli sulle allergie e affianca la direzione scientifica nello sviluppo del progetto in Sud America.",
    gia_role: "Medico Pediatra · Allergologia e Nutrizione Pediatrica",
    gia_creds: [ic('stethoscope') + " Medico Specialista in Pediatria · Pediatra di famiglia", ic('pill') + " Esperta in Allergologia Pediatrica", ic('microscope') + " Nutrizione pediatrica e svezzamento · protocolli personalizzati", ic('book') + " Board Società Italiana di Allergologia Pediatrica · Commissione nazionale Allergie Alimentari"],
    gia_p1: "La Dott.ssa Gianna Giuliana è medico specialista in Pediatria, esperta in allergologia pediatrica e in nutrizione pediatrica e svezzamento. Laureata in Medicina e Chirurgia a Brescia e specializzata con lode a Parma, dopo aver frequentato la facoltà di Dietistica e Nutrizione Umana.",
    gia_p2: "Ha maturato la formazione sulle patologie allergiche dell'età pediatrica in centri universitari italiani e internazionali — l'Ospedale dei Bambini «P. Barilla» di Parma, l'Ospedale Meyer di Firenze e il Children's Hospital di Philadelphia. Membro dei board della Società Italiana di Allergologia Pediatrica e della commissione nazionale per le Allergie Alimentari, con pubblicazioni su riviste nazionali e internazionali. A Rosignano è pediatra di famiglia e svolge attività specialistica privata in allergologia pediatrica, con consulenze di nutrizione pediatrica e protocolli personalizzati sullo svezzamento e sull'alimentazione nella prima infanzia.",
  ...
  es: {
    ...
    team_title: "Cinco competencias, <em>una sola misión.</em>",
    ...
    ame_role: "Referente Médica del Proyecto en Sudamérica",
    ame_creds: [ic('stethoscope') + " Médica Pediatra", ic('pill') + " Especialista en Alergia, Inmunología y Medicina Ambiental", ic('book') + " Subdirectora de la Carrera de Especialistas en Alergia e Inmunología (UBA)", ic('globe') + " Universidad de Buenos Aires (Argentina)"],
    ame_p1: "La Dra. Amelia Zarauza es la referente médica del proyecto para Sudamérica. Médica pediatra especializada en alergia, inmunología y medicina ambiental, pone su competencia clínica al servicio de los contenidos sobre alergias y seguridad alimentaria.",
    ame_p2: "Subdirectora de la Carrera de Especialistas en Alergia e Inmunología de la Universidad de Buenos Aires (UBA), ha realizado la revisión clínica del juego «El Coraje de Actuar» y de los módulos sobre alergias, y acompaña la dirección científica en el desarrollo del proyecto en Sudamérica.",
    gia_role: "Médica Pediatra · Alergia y Nutrición Pediátrica",
    gia_creds: [ic('stethoscope') + " Médica Especialista en Pediatría · Pediatra de familia", ic('pill') + " Experta en Alergia Pediátrica", ic('microscope') + " Nutrición pediátrica y alimentación complementaria · protocolos personalizados", ic('book') + " Miembro de los boards de la Sociedad Italiana de Alergia Pediátrica y de la comisión nacional de Alergias Alimentarias"],
    gia_p1: "La Dra. Gianna Giuliana es médica especialista en Pediatría, experta en alergia pediátrica y en nutrición pediátrica y alimentación complementaria. Licenciada en Medicina y Cirugía en Brescia y especializada con matrícula de honor en Parma, tras cursar la facultad de Dietética y Nutrición Humana.",
    gia_p2: "Se formó en las patologías alérgicas de la edad pediátrica en centros universitarios italianos e internacionales — el Hospital de los Niños «P. Barilla» de Parma, el Hospital Meyer de Florencia y el Children's Hospital de Filadelfia. Miembro de los boards de la Sociedad Italiana de Alergia Pediátrica y de la comisión nacional de Alergias Alimentarias, con publicaciones en revistas nacionales e internacionales. En Rosignano es pediatra de familia y desarrolla actividad especializada privada en alergia pediátrica, con consultas de nutrición pediátrica y protocolos personalizados sobre la alimentación complementaria y la alimentación en la primera infancia.",
  ...
  en: {
    ...
    team_title: "Five expertises, <em>one mission.</em>",
    ...
    ame_role: "Project Medical Advisor for South America",
    ame_creds: [ic('stethoscope') + " Paediatrician", ic('pill') + " Specialist in Allergy, Immunology & Environmental Medicine", ic('book') + " Deputy Director of the Allergy & Immunology Specialisation (UBA)", ic('globe') + " University of Buenos Aires (Argentina)"],
    ame_p1: "Dr. Amelia Zarauza is the project's medical advisor for South America. A paediatrician specialised in allergy, immunology and environmental medicine, she brings her clinical expertise to the content on allergies and food safety.",
    ame_p2: "Deputy Director of the Allergy & Immunology Specialisation programme at the University of Buenos Aires (UBA), she carried out the clinical review of «The Courage to Act» game and the allergy modules, and supports the scientific direction in developing the project in South America.",
    gia_role: "Paediatrician · Paediatric Allergy & Nutrition",
    gia_creds: [ic('stethoscope') + " Specialist in Paediatrics · Family paediatrician", ic('pill') + " Expert in Paediatric Allergy", ic('microscope') + " Paediatric nutrition & weaning · personalised protocols", ic('book') + " Board member, Italian Society of Paediatric Allergy & national Food Allergy commission"],
    gia_p1: "Dr. Gianna Giuliana is a specialist in Paediatrics, with expertise in paediatric allergy and in paediatric nutrition and weaning. She graduated in Medicine and Surgery in Brescia and specialised with honours in Parma, after studying Dietetics and Human Nutrition.",
    gia_p2: "She trained in paediatric allergic conditions at Italian and international university centres — the «P. Barilla» Children's Hospital in Parma, the Meyer Hospital in Florence and the Children's Hospital of Philadelphia. A board member of the Italian Society of Paediatric Allergy and of the national Food Allergy commission, she publishes regularly in national and international journals. In Rosignano she is a family paediatrician and runs a private practice in paediatric allergy, offering paediatric nutrition consultations with personalised protocols on weaning and early-childhood feeding.",
...
const TPL = {
  ...
  'ame-creds': t => t.ame_creds.map(c => `<div class="ser-cred">${c}</div>`).join(''),
  'gia-creds': t => t.gia_creds.map(c => `<div class="ser-cred">${c}</div>`).join(''),
