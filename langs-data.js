...
const T = {
  it: {
    ...
    ame_p1: "La Dott.ssa Amelia Zarauza è la referente medica del progetto in Sud America. Medico pediatra specializzata in allergologia, immunologia e medicina ambientale, garantisce il rigore clinico dei contenuti su allergie e sicurezza alimentare.",
    ame_p2: "Vicedirettrice della Carriera di Specializzazione in Allergologia e Immunologia all'Università di Buenos Aires (UBA), affianca la direzione scientifica nella validazione del gioco «Il Coraggio di Agire» e dei moduli sulle allergie.",
  ...
  es: {
    ...
    ame_p1: "La Dra. Amelia Zarauza es la referente médica del proyecto en Sudamérica. Médica pediatra especializada en alergia, inmunología y medicina ambiental, garantiza el rigor clínico de los contenidos sobre alergias y seguridad alimentaria.",
    ame_p2: "Subdirectora de la Carrera de Especialistas en Alergia e Inmunología de la Universidad de Buenos Aires (UBA), acompaña la dirección científica en la validación del juego «El Coraje de Actuar» y de los módulos sobre alergias.",
  ...
  en: {
    ...
    ame_p1: "Dr. Amelia Zarauza is the project's medical advisor for South America. A paediatrician specialised in allergy, immunology and environmental medicine, she ensures the clinical rigour of the content on allergies and food safety.",
    ame_p2: "Deputy Director of the Allergy & Immunology Specialisation programme at the University of Buenos Aires (UBA), she supports the scientific direction in validating the «The Courage to Act» game and the allergy modules.",
